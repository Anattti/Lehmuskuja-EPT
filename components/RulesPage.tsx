...
export const RulesPage: React.FC = () => {
    return (
        <div className="w-full max-w-5xl mx-auto px-4 py-8 sm:py-12 relative z-10 animate-fade-in">
            {/* Header */}
            <div className="text-center mb-8 sm:mb-16 relative">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 sm:w-64 sm:h-64 bg-brand-blue/20 rounded-full blur-[60px] sm:blur-[80px] -z-10"></div>
                <h2 className="text-xs sm:text-sm font-bold tracking-[0.3em] text-primary uppercase mb-2">Turnausohjesääntö</h2>
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-black text-white tracking-tighter mb-4 sm:mb-6">
                    SÄÄNNÖT & <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-brand-red">ETIKETTI</span>
                </h1>
                <p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-lg leading-relaxed px-2">
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                {/* General Rules */}
                <div className="bg-card-bg border border-border-green/50 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-lg relative overflow-hidden group hover:border-border-green transition-colors">
                    <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                        <span className="material-symbols-outlined text-6xl sm:text-8xl">balance</span>
                    </div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center gap-3">
                        <span className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-brand-blue flex items-center justify-center text-[10px] sm:text-xs">01</span>
                        Yleiset Periaatteet
                    </h3>
                    <ul className="space-y-3 sm:space-y-4 text-gray-300 text-sm sm:text-base">
                        <li className="flex gap-3">
                            <span className="material-symbols-outlined text-primary mt-0.5 text-base sm:text-lg">check</span>
                ...
                <div className="bg-card-bg border border-border-green/50 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-lg relative overflow-hidden group hover:border-border-green transition-colors">
                    <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                        <span className="material-symbols-outlined text-6xl sm:text-8xl">handshake</span>
                    </div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center gap-3">
                        <span className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-brand-red flex items-center justify-center text-[10px] sm:text-xs">02</span>
                        Pöytäetiketti
                    </h3>
                    <ul className="space-y-3 sm:space-y-4 text-gray-300 text-sm sm:text-base">
                        <li className="flex gap-3">
                            <span className="material-symbols-outlined text-brand-red mt-0.5 text-base sm:text-lg">block</span>
                ...
                {/* Game Structure */}
                <div className="bg-card-bg border border-border-green/50 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-lg md:col-span-2 relative overflow-hidden">
                    <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
                        <div className="flex-1 text-sm sm:text-base">
                            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center gap-3">
                                <span className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-primary text-background-dark flex items-center justify-center text-[10px] sm:text-xs font-bold">03</span>
                                Pelin Kulku
                            </h3>
                        ...
                        <div className="w-full md:w-1/3 bg-[#112117] rounded-xl p-4 sm:p-6 border border-border-green/30">
                            <h4 className="text-primary font-bold uppercase tracking-widest text-[10px] sm:text-xs mb-3 sm:mb-4">Seuraamukset</h4>
