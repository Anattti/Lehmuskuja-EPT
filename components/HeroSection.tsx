...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenPolicy }) => {
    ...
    return (
        <div className="relative z-10 flex flex-col items-center justify-center flex-grow py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
            ...
            <div className="w-full max-w-4xl relative mb-12 group">
                ...
                <div className="relative bg-card-bg border border-border-green rounded-xl sm:rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    {/* Content Wrapper */}
                    <div className="relative z-20 flex flex-col items-center justify-center text-center py-20 px-6 sm:py-32">
                        ...
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm mb-8">
                            ...
                            <span className="text-xs font-bold tracking-widest text-white uppercase">Live Tournament Series</span>
                        </div>

                        {/* Main Title Block */}
                        <div className="flex flex-col items-center">
                            <h1 className="text-white text-5xl sm:text-7xl md:text-8xl font-black tracking-tighter leading-[0.9] mb-4 drop-shadow-2xl">
                                <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-gray-400">
                                    LEHMUSKUJA
                                </span>
                                <br />
                                <span className="text-brand-blue relative inline-block mt-2 sm:mt-0">
                                    EPT
                                    <span className="absolute -top-2 -right-6 sm:-right-8 text-brand-red text-4xl sm:text-5xl material-symbols-outlined transform rotate-12">
                                        playing_cards
                                    </span>
                                </span>
                            </h1>
                            ...
                            {/* Divider Strip */}
                            <div className="h-1 w-32 bg-gradient-to-r from-brand-blue via-white to-brand-red rounded-full my-6"></div>

                            {/* Subtitle */}
                            <h2 className="text-gray-300 text-lg sm:text-2xl font-bold tracking-[0.2em] uppercase max-w-2xl px-4">
                        ...
                        <div className="mt-12 flex flex-col sm:flex-row gap-4 w-full justify-center">
                            <button 
                                ...
                                className="group relative inline-flex items-center justify-center px-8 py-4 bg-primary text-background-dark text-base font-bold uppercase tracking-wider rounded-full overflow-hidden transition-all hover:bg-primary-hover hover:scale-105 shadow-[0_0_30px_rgba(54,226,123,0.25)] w-full sm:w-auto"
                            >
                                ...
                                <span className="material-symbols-outlined mr-2">wine_bar</span>
                                Alkoholipolitiikka EPT:llä
                            </button>
                            <button 
                                onClick={() => setScheduleText('NYT!')}
                                className="inline-flex items-center justify-center px-8 py-4 bg-transparent border-2 border-white/20 text-white text-base font-bold uppercase tracking-wider rounded-full hover:bg-white/10 transition-all hover:border-white/40 w-full sm:w-auto"
                            >
